    ...
    <>
      <header className="flex items-center justify-between border-b border-emerald-900/30 bg-[#0f1711]/80 px-8 py-4 shadow-sm backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* 3. Botón de Carrito modificado para abrir el CartDrawer en lugar de redirigir */}
          <button
            type="button"
            onClick={() => setIsCartOpen(true)}
            aria-label="Ver carrito"
            className="relative flex items-center justify-center rounded-full border border-emerald-800/60 bg-emerald-900/20 p-2.5 text-emerald-100 transition-all hover:bg-emerald-800/60 hover:text-white cursor-pointer"
          >
      ...
      {/* 4. Renderizamos el componente del cajón deslizante */}
