...
export default function RegistroPage() {
  return (
    <div className="mx-auto mt-4 max-w-[420px] rounded-xl border border-neutral-200 bg-white p-8 shadow-sm">
      <div className="mb-8 text-center">
        <span className="mb-4 block text-4xl" role="img" aria-label="Mate">
          🧉
        </span>
      ...
      <form className="space-y-5">
        ...
        <div className="pt-2">
          <Button
            type="button"
            className="h-12 w-full rounded-xl bg-emerald-800 text-base font-medium hover:bg-emerald-900"
          >
            Registrarse
          </Button>
        </div>
